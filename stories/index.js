...
storiesOf("Appointment", module)
  ...
  .add("Form Edit", () => <Form student="Habon Hassan" interviewer="1" onSave={action("onSave")} onCancel={action("onCancel")} />)
  .add("Form Create", () => <Form onSave={action("onSave")} onCancel={action("onCancel")} />)
